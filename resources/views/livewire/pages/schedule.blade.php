    ...
    <section class="pt-10 pb-24 px-2 lg:px-5">
        <div class="flex flex-col lg:flex-row justify-between gap-4">
            <div class="flex justify-between">
                ...
                <a target="_blank" href="assets/download/schedule.pdf" class="btn btn-warning block lg:hidden"><i
            ...
            <div class="card hidden lg:block lg:w-1/4 bg-base-100 order-1 lg:order-2 shadow-sm">
                <div class="card-body">
                    <a target="_blank" href="assets/download/schedule.pdf" class="btn btn-warning rounded-lg"><i
                            class="fa fa-download"></i> Download Schedule</a>
                    <h2 class="card-title">Filter</h2>
                    <fieldset class="fieldset p-4 bg-base-100 border border-base-300 rounded-box w-64">
                        <legend class="fieldset-legend">Date</legend>
            ...
            <div class="w-full lg:w-3/4 order-2 lg:order-1">
                ...
                <div class="collapse bg-base-100 border border-base-300 my-2">
                    ...
                    <div class="collapse-title font-semibold">{{$atglance->title_ses}} - <span class="text-xs"><i
                            ...
                            @if ($atglance->detail_room === null)
                            {{$atglance->room}}
                            @else
                            {{$atglance->detail_room}}
                            @endif </span></div>
                        ...
                        <div class="flex flex-wrap justify-between gap-4 items-start">
                            <div>
                                ...
                                <p class="mb-2"><i class="fa fa-clock text-[#9E1F63]"></i> {{$atglance->time}} | <i
                                        class="fa fa-map-marker text-[#9E1F63]"></i> @if ($atglance->detail_room ===
                                    null)
                                    {{$atglance->room}}
                                    @else
                                    {{$atglance->detail_room}}
