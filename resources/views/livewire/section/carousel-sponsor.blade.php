            ...
            <div class="">
                ...
                <div class="mt-10">
                    <div class="mb-4 flex items-center justify-end gap-2 px-2" x-data="carouselSetupControls()">
                        <button type="button"
                            class="btn btn-sm btn-outline border border-warning rounded-full"
                            @click="$dispatch('sponsor-carousel-prev')">
                            <i class="fa-solid text-warning fa-chevron-left"></i>
                        </button>
                        <button type="button"
                            class="btn btn-sm btn-outline border border-warning rounded-full"
                            @click="$dispatch('sponsor-carousel-next')">
                            <i class="fa-solid text-warning fa-chevron-right"></i>
                        </button>
                    </div>
                    <div x-data="carouselSetup()" x-init="startInterval()" @resize.window="handleResize()"
                        ...
                        <div class="flex transition-transform duration-700 ease-in-out"
                            ...
                            <div class="flex-none border-r border-gray-300 last:border-0 px-3"
                                ...
                                <div class="tooltip tooltip-warning" data-tip="{{$sponsor->category}}">
                ...
                <div class="text-center my-10">
                    <a class="btn bg-warning hover:bg-[#a45b80] text-white rounded-xl uppercase" href="/sponsors">VIEW
                        MORE Sponsors</a>
                </div>
            </div>
        </div>
